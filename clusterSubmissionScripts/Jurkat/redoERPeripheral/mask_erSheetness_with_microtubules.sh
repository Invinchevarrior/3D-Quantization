...
ARGV="--datasetToMaskN5Path '/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/Jurkat.n5/contactDistance20.n5' \
--datasetNameToMask 'er_sheetnessVolumeAveraged' \
--datasetToUseAsMaskN5Path '/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/Jurkat.n5/contactDistance20.n5' \
--datasetNameToUseAsMask 'microtubules' \
--outputN5Path '/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/Jurkat.n5/contactDistance20.n5'"
