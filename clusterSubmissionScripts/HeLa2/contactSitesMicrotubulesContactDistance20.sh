...
ARGV="\
--inputPairs '\
er_maskedWith_microtubules_to_microtubules,\
er_maskedWith_nucleus_expanded_maskedWith_microtubules_to_microtubules,\
...
mito_maskedWith_microtubules_to_microtubules,\
MVB_maskedWith_microtubules_to_microtubules,\
vesicle_maskedWith_microtubules_to_microtubules,\
golgi_maskedWith_microtubules_to_microtubules,\
