...
datasetnames=microtubules,er,er_maskedWith_nucleus_expanded,nucleus,MVB,mito,vesicle

if [ "$i" -eq "2" ]
then
path=/groups/cosem/cosem/ackermand/paperResultsWithFullPaths/collected/HeLa2.n5/contactDistance20.n5
datasetnames=er_maskedWith_nucleus_expanded_maskedWith_microtubules_to_microtubules_cc,er_maskedWith_microtubules_to_microtubules_cc,nucleus_maskedWith_microtubules_to_microtubules_cc,MVB_maskedWith_microtubules_to_microtubules_cc,mito_maskedWith_microtubules_to_microtubules_cc,vesicle_maskedWith_microtubules_to_microtubules_cc
fi
